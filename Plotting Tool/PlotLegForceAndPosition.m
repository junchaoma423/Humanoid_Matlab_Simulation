...
for i = 1:l-1
    ...
    iter(i) = out.iter(1,1,i)';
    flag(i) = out.iter(2,1,i)';
...
% hold on; plot(t,My11,t,My21,'Linewidth',1.5);
xlabel('Time (s)');
ylabel('M_y (Nm)');
% xlim([0 1.8]);
...
% hold on; plot(t,Mz11,t,Mz21,'Linewidth',1.5);
xlabel('Time (s)');
ylabel('M_z (Nm)');
% xlim([0 1.8]);
% 
